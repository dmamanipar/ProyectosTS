...
public class PeriodoControllerIntegrateTest {
    ...
    public void setUp() {
        ...
        UsuarioCrearDto udto = new UsuarioCrearDto("Moises", "Mamani Pari", "moises@upeu.edu.pe",
                "Da12345*", "admin", "21548765", "upeu", "Activo", "SI");

        token = given()
                .contentType(ContentType.JSON)
                .body(new CredencialesDto("emoises@upeu.edu.pe", "Da12345*")) //.toCharArray()
